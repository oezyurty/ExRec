...
def train(params):
    ...
    old_ques_best_policy = DQNPolicy(
        model=actor,
        optim=actor_optim,
        observation_space=observation_space,
        action_space=action_space,
    ...
    extended_ques_best_policy = DQNPolicy(
        model=actor,
        optim=actor_optim,
        observation_space=observation_space,
        action_space=action_space,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_dir", type=str, default="./train_dqn_logs")
    parser.add_argument("--save_dir", type=str, default="./dqn_saved_models")
    parser.add_argument("--use_wandb", action="store_true")
    parser.add_argument("--wandb_project_name", type=str, default="dqn")
