...
from exercise_recommender.wrappers.td3_wrapper import TD3PolicyWrapper
...
def train(params):
    ...
    policy = TD3PolicyWrapper(
        ...
        # Different than DDPG Parameters:
        policy_noise=params["policy_noise"],
        update_actor_freq=params["update_actor_freq"],
    ...
    old_ques_best_policy = TD3PolicyWrapper(
        actor=actor,
        critic=critic,
        actor_optim=actor_optim,
        critic_optim=critic_optim,
    ...
    extended_ques_best_policy = TD3PolicyWrapper(
        actor=actor,
        critic=critic,
        actor_optim=actor_optim,
        critic_optim=critic_optim,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_dir", type=str, default="./train_td3_logs")
    parser.add_argument("--save_dir", type=str, default="./td3_saved_models")
    parser.add_argument("--use_wandb", action="store_true")
    parser.add_argument("--wandb_project_name", type=str, default="td3")
