...
from exercise_recommender.agents.all_kc_critic import AllKCCritic
from exercise_recommender.agents.all_kc_critic_dkt_sac import AllKCCriticDKTSAC
...
def train(params):
    ...
    print(f"Train env_num: {train_vectorized_env.env_num}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_n_episode", type=int, default=128)
