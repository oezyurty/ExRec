from exercise_recommender.envs.worst_kc_envs import WorstKCEnv, WorstKCTestEnv
...
from exercise_recommender.agents.dist_actor import DistActor
from exercise_recommender.agents.kc_critic import KCCritic
from exercise_recommender.agents.critic_dkt import CriticDKT
from exercise_recommender.wrappers.sac_wrapper import SACPolicyWrapper
...
def train(params):
    ...
    old_ques_valid_env = WorstKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
    ...
    extended_ques_valid_env = WorstKCTestEnv(
            ...
            wandb_prefix="Extended Ques Valid Env")
    ...
    exploration_noise = GaussianNoise(sigma=params["exploration_noise_sigma"])
    ...
    policy = SACPolicyWrapper(
        ...
        # Parameters different than DDPG:
        alpha=params["alpha"],
    ...
    old_ques_valid_replay_buffer.reset()
    extended_ques_valid_replay_buffer.reset()
    ...
    test_env_old_questions = WorstKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            ...
            wandb_prefix="Old Ques Validated Old Ques Test Env")
    
    old_ques_best_policy = SACPolicyWrapper(
        actor=actor,
        critic=critic,
        actor_optim=actor_optim,
        critic_optim=critic_optim,
    ...
    test_env_extended_questions = WorstKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
            ...
            wandb_prefix="Old Ques Validated Extended Ques Test Env")
    ...
    extended_ques_best_policy = SACPolicyWrapper(
        actor=actor,
        critic=critic,
        actor_optim=actor_optim,
        critic_optim=critic_optim,
    ...
    test_env_old_questions = WorstKCTestEnv(
            ...
            log_wandb=params["test_log_wandb"],
            question_bank=question_bank_old,
            wandb_prefix="Extended Ques Validated Old Ques Test Env")
    ...
    test_env_extended_questions = WorstKCTestEnv(
            ...
            log_wandb=params["test_log_wandb"],
            question_bank=question_bank_extended,
            wandb_prefix="Extended Ques Validated Extended Ques Test Env")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_dir", type=str, default="./train_sac_logs")
    parser.add_argument("--save_dir", type=str, default="./sac_saved_models")
    parser.add_argument("--use_wandb", action="store_true")
    parser.add_argument("--wandb_project_name", type=str, default="sac")
    ...
    parser.add_argument("--exploration_noise_sigma", type=float, default=0.1)
