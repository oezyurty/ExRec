from exercise_recommender.envs.worst_kc_envs import WorstKCDiscreteEnv, WorstKCDiscreteTestEnv
...
def train(params):
    ...
    old_ques_train_env = WorstKCDiscreteEnv(
    ...
    old_ques_valid_env = WorstKCDiscreteTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
    ...
    test_env_old_questions = WorstKCDiscreteTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
            ...
            wandb_prefix="Old Ques Test Env")
    ...
    extended_ques_train_env = WorstKCDiscreteEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["train_init_seq_size"], 
            batch_size=params["train_batch_size"],
    ...
    extended_ques_valid_env = WorstKCDiscreteTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
    ...
    test_env_extended_questions = WorstKCDiscreteTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
            ...
            reward_func=params["test_reward_func"],
            question_bank=question_bank_extended,
            wandb_prefix="Extended Ques Test Env")
