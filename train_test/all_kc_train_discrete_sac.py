from exercise_recommender.envs.all_kc_envs import DiscreteAllKCEnv, DiscreteAllKCTestEnv
...
import torch
from exercise_recommender.agents.all_kc_discrete_actor import AllKCDiscreteActor
from exercise_recommender.agents.all_kc_discrete_sac_value_kc_critic import AllKCDiscreteSACValueKCCritic
...
def train(params):
    ...
    old_ques_train_env = DiscreteAllKCEnv(
    ...
    old_ques_valid_env = DiscreteAllKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
    ...
    critic = AllKCDiscreteSACValueKCCritic(
        student_hidden_size=params["student_state_size"],
        hidden_size=params["hidden_size"],
        num_questions=old_question_bank.num_q
    ).to(device)
    ...
    test_env_old_questions = DiscreteAllKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
    ...
    extended_ques_train_env = DiscreteAllKCEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["train_init_seq_size"], 
            batch_size=params["train_batch_size"],
    ...
    extended_ques_valid_env = DiscreteAllKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
    ...
    test_env_extended_questions = DiscreteAllKCTestEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
