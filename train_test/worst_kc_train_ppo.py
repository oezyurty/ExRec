...
from exercise_recommender.agents.value_kc_critic import ValueKCCritic
from exercise_recommender.agents.value_critic_dkt import ValueCriticDKT
from exercise_recommender.wrappers.ppo_wrapper import PPOPolicyWrapper
...
def train(params):
            ...
            with torch_train_mode(policy):
                ...
                if params["use_wandb"]:
                    wandb.log({
                        ...
                        "clip_loss_mean": res.clip_loss.mean,
                        "vf_loss_mean": res.vf_loss.mean,
                        "ent_loss_mean": res.ent_loss.mean
                    }, commit=True)
    ...
    old_ques_best_policy = PPOPolicyWrapper(
        actor=actor,
        critic=critic,
        optim=actor_optim,
        dist_fn=dist_fn,
    ...
    extended_ques_best_policy = PPOPolicyWrapper(
        actor=actor,
        critic=critic,
        optim=actor_optim,
        dist_fn=dist_fn,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--log_dir", type=str, default="./train_ppo_logs")
    parser.add_argument("--save_dir", type=str, default="./ppo_saved_models")
