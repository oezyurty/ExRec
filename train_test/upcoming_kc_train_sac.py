from exercise_recommender.envs.broader_kc_envs import BroaderKCClusterEnv, BroaderKCTestClusterEnv
...
def train(params):
    ...
    old_ques_valid_env = BroaderKCTestClusterEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
    ...
    extended_ques_valid_env = BroaderKCTestClusterEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["valid_batch_size"],
    ...
    test_env_old_questions = BroaderKCTestClusterEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
    ...
    test_env_extended_questions = BroaderKCTestClusterEnv(
            question_embed_size=768, 
            pretrained_model_path=params["pretrained_model_path"],
            init_seq_size=params["test_init_seq_size"],
            batch_size=params["test_batch_size"],
